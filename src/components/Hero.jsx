  ...
  return (
    <>
      <div className="flex sm:flex-row flex-col-reverse sm:px-20 px-8 items-center justify-between">
        <div className="mr-10 mt-8 sm:mb-0">
          <h2 className="text-5xl text-dark font-semibold mb-5">
            Want anything to be <br className="hidden sm:inline" /> easy with
            <span className="font-bold"> LaslesVPN</span>.
          </h2>
          <p className="text-grey font-medium mb-12 ">
      ...
      <div className="flex sm:flex-row mt-28 sm:mx-20 py-16 px-8 bg-white flex-col justify-around sm:justify-between">
